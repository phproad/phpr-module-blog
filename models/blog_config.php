...
class Blog_Config extends Core_Settings_Base
{
	public $record_code = 'blog_config';
	...
	{
		$config_obj = new Blog_Config();
		return $config_obj->load();
	}
	...
	protected function build_form()
	{
		...
		$this->add_field('comment_notifications_rule', 'New comment notifications', 'full', db_number)->tab('Notifications')->display_as(frm_radio)->comment('Please choose which users should receive notifications about new blog comments.', 'above');
	}
